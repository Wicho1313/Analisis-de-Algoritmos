...
{		
	...
	this.startButton = addControlToAlgorithmBar("Button", "Empezar Kruskal");
...
Kruskal.prototype.setup = function() 
{
	...
	this.cmd("CreateLabel", this.nextIndex++, "Salida de Disociación", Kruskal.SET_ARRAY_START_X - 1 * Kruskal.SET_ARRAY_ELEM_WIDTH, Kruskal.SET_ARRAY_START_Y - Kruskal.SET_ARRAY_ELEM_HEIGHT * 1.5, 0);
...
Kruskal.prototype.doKruskal = function(ignored)
{
	...
	this.cmd("CreateLabel", (this.nextIndex)+1, "Se ordenan la aristas de menor a mayor",  Kruskal.MESSAGE_LABEL_X,10, 0);
	...
	{				
		this.cmd("CreateLabel", messageLabelID+1, "Tomamos la arista con menor peso",  Kruskal.MESSAGE_LABEL_X,10, 0);
		this.cmd("SetTextColor", messageLabelID+1, "#FF0000");
		this.cmd("Step");
		...
		this.cmd("SetText", findLabelLeft, "Nodo(" + String(this.edgesListLeft[nextListIndex]) + ") = ");
		...
		this.cmd("SetText", findLabelLeft, "Nodo(" + String(this.edgesListLeft[nextListIndex]) + ") = " + String(left));
		
		
		this.cmd("SetText", findLabelRight, "Nodo(" + String(this.edgesListRight[nextListIndex]) + ") = ");
		...
		this.cmd("SetText", findLabelRight, "Nodo(" + String(this.edgesListRight[nextListIndex]) + ") = " + String(right));
		
		this.cmd("Step");
		this.cmd("SetText", messageLabelID+1, "Verficamos si los vertices pertenescan a diferentes conjuntos o diferente arbol");
		this.cmd("SetTextColor", messageLabelID+1, "#FF0000");
		this.cmd("Step");
		if (left != right)
		{
			this.cmd("CreateLabel", messageLabelID, "Vértices en diferentes árboles.  Agregar al árbol: Unión(" + String(left) + "," + String(right) + ")",  Kruskal.MESSAGE_LABEL_X, Kruskal.MESSAGE_LABEL_Y, 0);
			this.cmd("Step");
			this.highlightEdge(this.edgesListLeft[nextListIndex], this.edgesListRight[nextListIndex], 1)
			this.highlightEdge(this.edgesListRight[nextListIndex], this.edgesListLeft[nextListIndex], 1)
			edgesAdded++;
		...
		{
			this.cmd("CreateLabel", messageLabelID, "Vértices en el mismo árbol.  Saltar borde",  Kruskal.MESSAGE_LABEL_X, Kruskal.MESSAGE_LABEL_Y, 0);
			this.cmd("Step");
		...
		this.cmd("Delete", messageLabelID+1);
