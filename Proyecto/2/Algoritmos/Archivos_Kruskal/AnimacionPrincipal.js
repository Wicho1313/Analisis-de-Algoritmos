...
function animStarted()
{
	...
	objectManager.statusReport.setText("Animación Corriendo");
...
function initCanvas()
{
	...
	skipBackButton = addControlToAnimationBar("Button", "Saltar Atrás");
	skipBackButton.onclick = animationManager.skipBack.bind(animationManager);
	stepBackButton = addControlToAnimationBar("Button", "Paso Atrás");
	stepBackButton.onclick = animationManager.stepBack.bind(animationManager);
	playPauseBackButton = addControlToAnimationBar("Button", "Pausa");
	playPauseBackButton.onclick = doPlayPause ;
	stepForwardButton = addControlToAnimationBar("Button", "Paso Adelante");
	stepForwardButton.onclick = animationManager.step.bind(animationManager) ;
	skipForwardButton = addControlToAnimationBar("Button", "Saltar Adelante");
	...
	var txtNode = document.createTextNode("Velocidad de Animación"); 
	midLevel.appendChild(bottomLevel);
	...
	//element.setAttribute("style", "height:500px");
	...
	*/
//	heightEntry.size = 4;
	//sizeButton = addControlToAnimationBar("Button", "Cambiar el tamaño del canvas");
