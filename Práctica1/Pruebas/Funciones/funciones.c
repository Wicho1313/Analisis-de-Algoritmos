...
{
	char * algorit = (char *) malloc (sizeof (char));
	switch (algoritmo)
	{
		case 1:
			strcpy (algorit, "Simple Bubble Sort");
			break;
		case 2:
			strcpy (algorit, "Optimized Bubble Sort");
			break;
		case 3:
			strcpy (algorit, "Insertion Sort");
			break;
		case 4:
			strcpy (algorit, "Selection Sort");
			break;
		case 5:
			strcpy (algorit, "Shell Sort");
			break;
		case 6:
			strcpy (algorit, "Binary Tree Sort");
			break;
	}
	printf("Tiempo con el algoritmo %s con n = %d\n", algorit, n);
	printf("\n\n");
