...
int ParalellBinarySearch
    ...
    pthread_t* Workers = (pthread_t*) malloc(NumOfWorkers * sizeof(pthread_t));      //Now get the array worker

    BinarySearchData* Parameters = (BinarySearchData*) malloc(NumOfWorkers*sizeof(BinarySearchData));              //Now create the parameters data
